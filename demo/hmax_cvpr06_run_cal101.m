...
dataPath = '';                % Path where the Caltech 101 dataset can be found (*** required ***).
...
numTrain    = 30;             % Number of training images per category.
...
if ~exist(fullfile(dataPath, 'accordion'), 'dir')
...
for i = 1 : numel(catNames)
    ...
    files = dir(fullfile(dataPath, catNames{i}, 'image_*'));
